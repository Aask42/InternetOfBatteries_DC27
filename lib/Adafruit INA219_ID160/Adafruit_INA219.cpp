...
void Adafruit_INA219::setCalibration_16V_500mA() {
  ...
  // 3. Calculate possible range of LSBs (Min = 15-bit, Max = 12-bit)
  // MinimumLSB = MaxExpected_I/32767
  // MinimumLSB = 0.0000153              (15uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.0001221              (122uA per bit)
  ...
  //
  // Max_Current_Before_Overflow = Max_Current
  // Max_Current_Before_Overflow = 0.65534A
  //
  // Max_ShuntVoltage = Max_Current_Before_Overflow * RSHUNT
  // Max_ShuntVoltage = 0.131068V
  //
  ...
  //
  // Max_ShuntVoltage_Before_Overflow = Max_ShuntVoltage
  // Max_ShuntVoltage_Before_Overflow = 0.131068V

  // 8. Compute the Maximum Power
  // MaximumPower = Max_Current_Before_Overflow * VBUS_MAX
  // MaximumPower = 0.131068 * 16V
  // MaximumPower = 2.097W
